...
// Calls the Vercel serverless function at /api/chat — the Gemini key never appears here.

const API_URL = '/api/chat'; // handled by api/chat.js on Vercel
...
async function sendMessage() {
  ...
  try {
    ...
    hideTyping();
    showToast('Cannot reach the server. Check the deployment.', 'err');
    messages.pop();
  }
